"""LambdaRank v3 — tighter top-N focus and seed-stability check."""
...
def run_one(model_id, max_position, seed, n_rounds, learning_rate, num_leaves, feature_fraction):
    ...
    params = {
        ...
        "lambda_l2": 1.0,
        "verbosity": -1, "max_position": max_position, "seed": seed,
    ...
    preds["model_type"] = "lambdarank_v3"
...
if __name__ == "__main__":
    # Sweep: max_position × seed × hyperparams
    configs = [
        ("lambdarank_v3_p25_s42",  25, 42,  600, 0.03, 31, 0.3),
        ("lambdarank_v3_p50_s7",   50,  7,  600, 0.03, 31, 0.3),
        ("lambdarank_v3_p50_s99",  50, 99,  600, 0.03, 31, 0.3),
        ("lambdarank_v3_p100_s42", 100, 42, 600, 0.03, 31, 0.3),
        ("lambdarank_v3_p50_lv15", 50, 42,  600, 0.03, 15, 0.3),
    ]
    for cfg in configs:
        print(f"\n=== {cfg[0]} ===")
        run_one(*cfg)
