"""LambdaRank LightGBM + anonymous price features."""
...
def main(model_id: str = "lgbm_lambdarank_price"):
    ...
    print(f"train rows {len(ytr)} in {len(g_tr)} groups; X width {Xtr.shape[1]}")
    ...
    preds["model_type"] = "lambdarank_price"
