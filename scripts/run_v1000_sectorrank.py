"""H2: sector-neutral rank target, in-memory build → train Ridge+price → save predictions."""
...
def main(model_id: str = "ridge_price_sectorrank", model_kind: str = "ridge"):
    # Load with existing scaled samples (already have ex_ante_scale + raw_log_return)
    ...
    # Merge sector, recompute sector-neutral rank target
