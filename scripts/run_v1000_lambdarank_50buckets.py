"""LambdaRank with 50 label buckets instead of 31."""
...
def main(model_id: str = "lambdarank_v3_p25_50buckets", n_buckets: int = 50,
         max_position: int = 25):
    ...
    params = {
        ...
        "label_gain": [pow(2, i) - 1 for i in range(n_buckets)],
    }
    print(f"training LambdaRank with {n_buckets} label buckets, max_position={max_position}...")
    ...
    preds["model_type"] = "lambdarank_50buckets"
